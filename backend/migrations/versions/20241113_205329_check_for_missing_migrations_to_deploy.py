...
def upgrade():
    ...
    sa.ForeignKeyConstraint(['user_id'], ['ask_geeves.users.id'], ),
    sa.PrimaryKeyConstraint('id'),
    sa.UniqueConstraint('user_id', 'content_type', 'content_id', name='unique_save_user'),
    schema='ask_geeves'
    )
    ...
    sa.Column('total_score', sa.Integer(), nullable=True),
    sa.Column('id', sa.Integer(), nullable=False),
    sa.ForeignKeyConstraint(['question_id'], ['ask_geeves.questions.id'], ),
    sa.ForeignKeyConstraint(['user_id'], ['ask_geeves.users.id'], ),
    sa.PrimaryKeyConstraint('id'),
    schema='ask_geeves'
    )
    ...
    sa.ForeignKeyConstraint(['question_id'], ['ask_geeves.questions.id'], ),
    sa.ForeignKeyConstraint(['tag_id'], ['ask_geeves.tags.id'], ),
...
def downgrade():
    # ### commands auto generated by Alembic - please adjust! ###
    op.drop_table('question_tags', schema='ask_geeves')
    op.drop_table('answers', schema='ask_geeves')
