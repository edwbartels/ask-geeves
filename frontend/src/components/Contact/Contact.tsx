    ...
    <div className="contact-container">
      ...
      <div className="top-row">
        <div className="top-left-box">
          <div>
            <h2 className="name">Eddie Bartels</h2>
          </div>
          <div>
            <img className="image" src="/Eddie.jpg" />
          </div>
          <p className="eddie-description">Full Stack Software Engineer</p>
        </div>
        <div className="top-right-box">
          <div>
            <h2 className="name">Joshua Wang</h2>
          </div>
          <div>
            <img className="image" src="/Josh.jpg" />
          </div>
      ...
      <div className="bottom-row">
        <div className="bottom-left-box">
          <div>
            <h2 className="name">Tina Konopko</h2>
          </div>
          <div>
            <img className="image" src="/Tina.jpg" />
          </div>
          <p className="tina-description">Full Stack Software Engineer</p>
        </div>
        <div className="bottom-right-box">
          <div>
            <h2 className="name">Ziwen Zhang</h2>
          </div>
          <div>
            <img className="image" src="/Ziwen.jpg" />
          </div>
